  ...
  return (
    <section className="relative overflow-visible bg-[#3dc1ff] px-6 md:px-10 py-20 md:py-24">
      <div className="mx-auto max-w-[560px]">
        {title && (
          <h2 className="mb-8 text-center text-[#0b1b3b] font-semibold text-5xl leading-[1.05] text-[clamp(32px,6vw,72px)] tracking-tight">
            {title}
          </h2>
        )}

        {/* Phone wrapper (PADDING = border; nothing overlays the video) */}
        <div
          className="
            mx-auto w-full max-w-[480px]
            rounded-[40px] p-[14px]                 /* ← border thickness */
            bg-[conic-gradient(from_200deg_at_30%_0%,#3dadff,#6fa8ff_40%,#a56bff)]
            shadow-[0_24px_60px_rgba(0,0,0,0.35)]
          "
        >
          {/* Board/backplate directly behind video (same size) */}
          <div
            className="
            ...
            "
          >
            {/* Video — cannot be covered because there are NO absolute overlays */}
            <motion.video
              ...
              className="
                ...
                rounded-[0] object-cover bg-black
              "
            >
