...
export default function AboutPage() {
  return (
    <main className="mx-auto max-w-3xl px-6 py-16 leading-7 text-deepBlue dark:text-neutral-100">
      <h1 className="text-3xl font-bold mb-2 text-deepBlue">About Hypewave AI</h1>
      <p className="text-sm mb-8 text-deepBlue opacity-70">Your Personal Trading Assistant</p>
      ...
      <hr className="my-8 border-deepBlue/20 dark:border-white/10" />

      <section aria-labelledby="mission">
        <h2 id="mission" className="text-xl font-semibold mt-2 mb-2 text-deepBlue">Mission & Beliefs</h2>
        <p className="mb-4">
      ...
      <section aria-labelledby="what" className="mt-8">
        <h2 id="what" className="text-xl font-semibold mb-2 text-deepBlue">What Hypewave Is</h2>
        <p className="mb-4">
      ...
      <section aria-labelledby="who" className="mt-8">
        <h2 id="who" className="text-xl font-semibold mb-2 text-deepBlue">Who Hypewave Is For</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
      ...
      <section aria-labelledby="worth" className="mt-8">
        <h2 id="worth" className="text-xl font-semibold mb-2 text-deepBlue">Why Hypewave Is Worth It</h2>
        ...
        <blockquote className="border-l-4 pl-4 italic text-deepBlue/80 dark:text-neutral-100/80 border-deepBlue/30 dark:border-white/30 mb-6">
      ...
      <section aria-labelledby="how" className="mt-8">
        <h2 id="how" className="text-xl font-semibold mb-2 text-deepBlue">How Hypewave Works</h2>

        <h3 className="text-lg font-semibold mt-4 mb-1 text-deepBlue">1) Signals Engine</h3>
        ...
        <h3 className="text-lg font-semibold mt-4 mb-1 text-deepBlue">2) Chat Analyst</h3>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-semibold mt-4 mb-1 text-deepBlue">3) News & Macro Layer</h3>
        <p className="mb-6">
      ...
      <section aria-labelledby="novel" className="mt-8">
        <h2 id="novel" className="text-xl font-semibold mb-2 text-deepBlue">Novel Capabilities</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
      ...
      <section aria-labelledby="arch" className="mt-8">
        <h2 id="arch" className="text-xl font-semibold mb-2 text-deepBlue">Platform & Architecture (for Builders)</h2>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <div className="rounded-md border border-deepBlue/20 dark:border-white/20 p-4">
      ...
      <section aria-labelledby="ethics" className="mt-8">
        <h2 id="ethics" className="text-xl font-semibold mb-2 text-deepBlue">Data Ethics, Security & Privacy</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
      ...
      <section aria-labelledby="not" className="mt-8">
        <h2 id="not" className="text-xl font-semibold mb-2 text-deepBlue">What Hypewave Doesn’t Do (On Purpose)</h2>
        <ul className="list-disc pl-6 space-y-2 mb-4">
        ...
        <p className="text-xs text-deepBlue/70 dark:text-neutral-400">
      ...
      <section aria-labelledby="roadmap" className="mt-8">
        <h2 id="roadmap" className="text-xl font-semibold mb-2 text-deepBlue">Roadmap (Selected)</h2>
        <div className="grid gap-6 md:grid-cols-3">
          <div className="rounded-lg border border-deepBlue/20 dark:border-white/20 p-4">
            <h3 className="font-semibold mb-2 text-deepBlue">Short‑Term</h3>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <div className="rounded-lg border border-deepBlue/20 dark:border-white/20 p-4">
            <h3 className="font-semibold mb-2 text-deepBlue">Mid‑Term</h3>
            <ul className="list-disc pl-6 space-y-1">
          ...
          <div className="rounded-lg border border-deepBlue/20 dark:border-white/20 p-4">
            <h3 className="font-semibold mb-2 text-deepBlue">Long‑Term</h3>
            <ul className="list-disc pl-6 space-y-1">
        ...
        <p className="text-xs text-deepBlue/70 dark:text-neutral-400 mt-3">
          Roadmap items are directional and may change as we learn from users.
        </p>
      </section>

      <section aria-labelledby="pricing" className="mt-8">
        <h2 id="pricing" className="text-xl font-semibold mb-2 text-deepBlue">Pricing & Plans (Preview)</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
        ...
        <p className="text-xs text-deepBlue/70 dark:text-neutral-400">Contact us for educational/community pricing.</p>
      </section>

      <section aria-labelledby="support" className="mt-8">
        <h2 id="support" className="text-xl font-semibold mb-2 text-deepBlue">Support & Community</h2>
        <ul className="list-disc pl-6 space-y-2 mb-6">
      ...
      <section aria-labelledby="origin" className="mt-8">
        <h2 id="origin" className="text-xl font-semibold mb-2 text-deepBlue">Origin Story</h2>
        <p className="mb-6">
      ...
      <section aria-labelledby="faqs" className="mt-8">
        <h2 id="faqs" className="text-xl font-semibold mb-2 text-deepBlue">FAQs</h2>
        <details className="rounded-lg border border-deepBlue/20 dark:border-white/20 p-4 mb-3">
        ...
        <details className="rounded-lg border border-deepBlue/20 dark:border-white/20 p-4">
